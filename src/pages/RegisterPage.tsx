...
export default function RegisterPage() {
  ...
  return (
    <AuthShell
      ...
      subtitle="Empieza a gestionar tus productos"
      error={error}
      footer={<>¿Ya tienes cuenta? <Link to="/login" style={{ color: 'var(--c-primary)', fontWeight: 700 }}>Inicia sesión</Link></>}
    >
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        <div className="field">
          <label className="field-label">Nombre completo</label>
          <div style={{ position: 'relative' }}>
            <UserIcon size={18} style={{ position: 'absolute', left: 14, top: '50%', transform: 'translateY(-50%)', color: 'var(--c-text-subtle)' }} />
        ...
        <div className="field">
          ...
          <div style={{ position: 'relative' }}>
            ...
            <input className="input" type={showPass ? 'text' : 'password'} required minLength={6}
